  ...
  context "#sub_message" do
    ...
    context "with a pending user friendship" do
      ...
      should "return the correct message" do
        assert_equal "Do you really want to be friends with #{@friend.full_name}?", @decorator.sub_message
      end
    end
    ...
    context "with an accepted user friendship" do
      ...
      should "return the correct message" do
        assert_equal "You are friends with #{@friend.full_name}.", @decorator.sub_message
      end
    end
